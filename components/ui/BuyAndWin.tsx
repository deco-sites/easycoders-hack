  ...
  return (
    <section class="w-full h-full flex items-center justify-start relative">
      ...
      <div
        class={`${
          isExpandedWidth
            ? "flex-row w-full text-start justify-between"
            : "w-[202px] flex-col text-center"
        } h-full flex items-center bg-white border border-solid border-black rounded-lg p-2`}
      >
        <h1
          class={`${
            isExpandedWidth && "max-w-[50%]"
